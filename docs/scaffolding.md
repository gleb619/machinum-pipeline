...
| T047 | Architectural tests — LLM Router Proxy                | `blocked` | `L`  | router         | —                             | T052       | —      | [plans/llm-router.md](plans/llm-router.md)                   |
| T048 | Architectural tests — MCP Server                      | `blocked` | `L`  | mcp            | —                             | T053       | —      | [plans/mcp-server.md](plans/mcp-server.md)                   |
