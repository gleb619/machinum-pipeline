...
public interface ToolCompiler extends YamlCompiler<ToolManifest, ToolDefinition> {
  ...
  ToolDefinition compile(ToolManifest source, @Context CompilationContext ctx);

  @Named("compileNestedTools")
  default List<ToolDefinition> compileNestedTools(
